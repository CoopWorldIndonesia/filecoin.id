    ...
    <div class="row text-center navlink-package">
        <div class="col-lg-4 col-md-4 my-2">
            <a class="text-white text-decoration-none" href="<?= base_url('user/package'); ?>">
                <div class="link-package active">MINING FIL</div>
            </a>
        </div>
        <div class="col-lg-4 col-md-4 my-2">
            <a class="text-white text-decoration-none" href="<?= base_url('user/packageTour'); ?>">
                <div class="link-package">TOUR</div>
            </a>
        </div>
        <div class="col-lg-4 col-md-4 my-2">
                ...
                <div class="card shadow h-100 bg-trans bd-none">
                    <div class="card-body">
                        ...
                        <div class="mining-package" style="background-image:url(<?= base_url('assets/img/') . $row_filecoin->img; ?>);">
                            <p class="p-mining-1 font-wight-bold text-white"><?= $row_filecoin->daysmining; ?><span class="span-mining-1 text-white"> Days of Mining</span></p>
                            <p class="p-mining-2 font-wight-bold text-white" style="margin-top:-25px"><?= $row_filecoin->daysmining / 2; ?><span class="span-mining-2 text-white"> Days Free Cost</span></p>
                            <p class="p-mining-3 font-wight-bold text-white" style="margin-top:-25px"><?= $row_filecoin->daysmining / 2; ?><span class="span-mining-3 text-white"> Days Paid Cost</span></p>
                            <p class="p-mining-4 font-italic text-white mt-4 mb-0">Start After :</p>
                            <p class="p-mining-5 font-italic text-white mb-0"><?= $row_filecoin->startafter; ?> Days for FIL</p>
                            <p class="p-mining-6 font-italic text-white" style="margin-top:-7px">7 Days for MTM</p>
                            <p class="p-mining-7 font-italic text-white mb-0" style="margin-top: -8px;">Hashrate : <span class="span-mining-7"><?= $row_filecoin->hashrate; ?> GiB</span></p>
                        </div>
                        <div class="my-3 mx-auto buy-package">
                            <a href="<?= base_url() . 'user/fil/' . $row_filecoin->id; ?>" class="btn btn-bonus btn-block">BUY</a>
                        </div>
                    </div>
                </div>
            </div>
