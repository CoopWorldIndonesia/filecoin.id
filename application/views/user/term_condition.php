        ...
        <div class="col-md-12">
            <div class="term-condition">
                ...
                <form class="user" method="post" action="<?= base_url('user/cart') ?>">
                    <div class="form-group">
                        <label class="text-white mb-1" for="balance">Balance</label>
                        <input type="text" class="form-control" id="balance" name="balance" value="<?= number_format($general_balance_fil, 10) ?> FIL" placeholder="Balance" readonly>
                        <p id="lowBalance"></p>
                    </div>
                    <div class="form-group">
                        <label class="text-white mb-1" for="balance">Package Price</label>
                        <input type="text" class="form-control" id="price" name="price" value="<?= $price_fil; ?> FIL" placeholder="Price" readonly>
                    </div>
                    <?php
                    if (empty($cart['name'])) {
                    ?>
                        ...
                        <div class="mb-3">
                            <label class="text-white mb-1" for="selectline">Select Line</label>
                    ...
                    <div class="form-check mt-4 my-2">
                        ...
                        <label class="form-check-label text-white" for="flexAccept">
                            Terms and Conditions Please remember : any Filecoin transaction is subject to transaction fees. in case of withdrawal, the nal sum will have a small fee deducted. This is not due to our policy, but results form how lecoin transactions are structured
                        </label>
                    ...
                    <div class="form-check my-2">
                        ...
                        <label class="form-check-label text-white" for="flexAgreePrivacy">
                            I agree with provisions of the privacy policy
                        </label>
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="p-5">
                            <a class="btn btn-ok btn-block wd-px" id="btnBuy" href="#" data-toggle="modal" data-target="#notificationModal">BUY</a>
                        </div>
                        <div class="p-5">
                            ...
                            <a href="<?= base_url('user/package'); ?>" class="btn btn-cancel btn-block wd-px" data-toggle="modal" data-target="#cancelModal">
                                CANCEL
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="cancelModalLabel">Notification Alert!</h5>
                                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">×</span>
                                    </button>
                                </div>
                                <div class="modal-body">Setelah klik OK, uang tidak bisa kembali!</div>
...
<div class="modal fade" id="cancelModal" tabindex="-1" role="dialog" aria-labelledby="cancelModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="cancelModalLabel">Ready to Cancel Purchase?</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">Select "OK" below if you are ready to cancel this purchase.</div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                <a class="btn btn-primary" href="<?= base_url('user/package'); ?>">OK</a>
            </div>
        </div>
    </div>
</div>