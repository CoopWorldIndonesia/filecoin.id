            ...
            <div class="card shadow py-2 bg-trans bd-none">
                <div class="card-body tour-body mx-auto" style="width: fit-content;">
                    ...
                    <div class="my-3 mx-auto">
                        ...
                        <a href="<?= base_url('user/packageBaliVIP'); ?>" class="btn-tour btn btn-bonus btn-block font-italic">TOUR BALI</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow py-2 bg-trans bd-none">
                <div class="card-body tour-body mx-auto" style="width: fit-content;">
                    ...
                    <div class="my-3 mx-auto">
                        ...
                        <a href="<?= base_url('user/packageBaliVvIP'); ?>" class="btn-tour btn btn-bonus btn-block font-italic">TOUR BALI + NYEPI</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow py-2 bg-trans bd-none">
                <div class="card-body tour-body mx-auto" style="width: fit-content;">
                    ...
                    <div class="my-3 mx-auto">
                        ...
                        <a href="<?= base_url('user/packageBaliGoldVVIP'); ?>" class="btn-tour btn btn-bonus btn-block font-italic">TOUR BALI + NYEPI</a>
                    </div>
                </div>
            </div>
        </div>
