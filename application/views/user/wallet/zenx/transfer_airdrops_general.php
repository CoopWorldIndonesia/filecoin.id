    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="term-condition">
                <h4 class="text-white text-center mb-3">Airdrops Balance</h4>
                <form method="post" action="<?php base_url('user/transfer_airdrops_zenx') ?>">
                    <div class="form-group btn border-withdrawal text-white" style="width: 100%; text-align:left !important; cursor:default">
                        <span><img src="<?= base_url('assets/img/zenith_logo.png') ?>" width="25px">&nbsp; <b>ZENX WALLET</b></span> <span class="float-right"><b>0,0000000000 ZENX</b></span>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <a href="<?= base_url('user/walletzenxairdrop'); ?>" class="btn btn-cancel btn-user btn-block">
                                CANCEL
                            </a>
                        </div>
                    </div>
