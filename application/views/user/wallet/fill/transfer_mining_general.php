...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-white my-home-title">TRANSFER TO GENERAL</h1>
    <!--./ Page Heading -->
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="term-condition">
                <h4 class="text-white text-center mb-3">Mining Balance</h4>
                <form method="post" action="<?php base_url('user/transfer_mining_fil') ?>">
                    <div class="form-group btn border-withdrawal text-white" style="width: 100%; text-align:left !important; cursor:default">
                        <span><img src="<?= base_url('assets/img/filcoin_logo.png') ?>" width="25px">&nbsp; <b>FIL WALLET</b></span> <span class="float-right"><b><?= str_replace('.', ',', number_format($balance, 10)); ?> FIL</b></span>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <a href="<?= base_url('user/walletfillmining'); ?>" class="btn btn-cancel btn-user btn-block">
                                CANCEL
                            </a>
                        </div>
                    </div>
