                            ...
                            <div class="card shadow p-2 card-market-index" style="height:145px">
                                <div class="d-flex h-100">
                                    ...
                                    <div class="p-2 position-relative w-50">
                                        ...
                                        <p class="font-market-index text-right text-white mb-0 position-absolute" style="font-size:16px; bottom:0; right:7px"><?= str_replace('.', ',', number_format($general_balance_mtm, 10)); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
