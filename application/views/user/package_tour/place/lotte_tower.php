    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 text-white mx-auto justify-content-center text-justify">
                <img src="<?= base_url('assets/photo/tour/lotte-tower.jpg'); ?>" alt="Lotte Tower" class="mb-4 img-placetour">
                <h2 class="font-italic font-weight-bold">LOTTE TOWER</h2>
                <p>Lotte World Tower adalah sebuah gedung pencakar langit 123 lantai dengan ketinggian 555,7 meter (1.823 kaki) yang terletak di Seoul, Korea Selatan. Dibuka untuk umum pada 11 April 2017, dan saat ini merupakan gedung tertinggi di Korea Selatan dan tertinggi kelima di dunia.</p>
                <p>Sekedar informasi, arsitek Lotte World Tower bertujuan membuat gedung agar ramah lingkungan. Hal itu ditunjukkan dengan digunakannya panel surya, turbin angin, dan sistem pemanenan air hujan. Dibutuhkan 3.500 pekerja per harinya untuk membangun World Lotte Tower.
                    Total, dibutuhkan hingga 5 juta orang untuk menyelesaikan pembangunan gedung tersebut.</p>
                <p>Gedung yang dibangun sejak 2011 dan selesai pada 2016 itu, di dalamnya terdapat hotel bintang tujuh, observasi kaca yang terletak di ketinggian 500 meter, kafe rooftop, dan sejumlah kantor.
                    Selain itu, gedung tersebut juga berdekatan dengan Lotte World Mall and Lotte Department Store. Hal itu menjadikannya kompleks perbelanjaan terbesar di Korea Selatan.</p>
            </div>
        </div>
    </div>
