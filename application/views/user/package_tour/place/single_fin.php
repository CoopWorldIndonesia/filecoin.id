    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 text-white mx-auto justify-content-center text-justify">
                <img src="<?= base_url('assets/photo/tour/single-fin.jpg'); ?>" alt="Single Fin" class="mb-4 img-placetour">
                <h2 class="font-italic font-weight-bold">SINGLE FIN</h2>
                <p>Kafe Single Fin Uluwatu ini memang memiliki lokasi yang sangat tepat untuk sarana menyaksikan pemandangan sunset. Kafe ini berada di pinggir tebing. Lokasi kafe ini tepat di bawah Hotel Blue Point yang terkenal memiliki pemandangan indah.
                    Tidak hanya itu, wisatawan yang berkunjung ke sini juga berkesempatan untuk menyaksikan para peselancar yang tengah mengadu nyali dengan ombak.</p>
                <p>Lokasi kafe ini pun dulunya memang sudah dikenal sebagai tempat nongkrong yang paling asyik. Terutama untuk bisa menyaksikan keseruan para peselancar serta pemandangan matahari terbenam.
                    Dengan lokasinya seperti itu, tempat ini pun menggantikannya dan membuatnya menjadi lebih seru. Tidak heran kalau wisatawan mancanegara pun kerap menghabiskan waktunya untuk sekadar mampir ke tempat ini.
                    Dengan suasana seperti itu, tidak heran kalau kafe ini menjadi tempat yang menarik untuk menghabiskan waktu romantis bersama pasangan. Momen yang paling tepat untuk datang ke tempat ini adalah saat sore hari.
                    Anda bisa mengajak pasangan untuk bersama-sama menyaksikan pemandangan matahari terbenam dari area kafe.</p>
                <p>Lokasi terbaik untuk menyaksikan pemandangan matahari terbenam di Kafe Single Fin Uluwatu ini adalah di area balkoni.
                    Namun, untuk memperoleh tempat terbaik ini, Anda harus melakukan pemesanan terlebih dulu biar bisa memperoleh tempat. Pemesanan bisa dilakukan dengan mudah, lewat situs resmi Kafe Single Fin Bali.
                    Untuk bisa merasakan sensasi menyantap makanan dengan suguhan pemandangan sunset mengagumkan di kafe ini, Anda bisa berkunjung langsung ke Single Fin Uluwatu yang berlokasi di Jalan Mamu, Uluwatu, Pecatu, Kuta Selatan.</p>
            </div>
        </div>
    </div>
