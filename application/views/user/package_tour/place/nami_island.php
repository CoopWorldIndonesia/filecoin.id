    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 text-white mx-auto justify-content-center text-justify">
                <img src="<?= base_url('assets/photo/tour/nami-island.jpg'); ?>" alt="Nami Island" class="mb-4 img-placetour">
                <h2 class="font-italic font-weight-bold">NAMI ISLAND</h2>
                <p>Nami Island, atau Pulau Nami ini tentu sudah sangat akrab di telinga, terutama bagi pencinta drama Korea.
                    ...
                    Pulau mungil berdiameter 6 kilometer dan luas area sekitar 460.000 m2 ini, berbentuk setengah lingkaran atau seperti sebuah mangkok.</p>
                <p>Nami Island sendiri memperoleh namanya yang diambil dari nama salah satu pahlawan Korea Selatan, yaitu Jenderal Nami. Makam sang jederal juga berada di pulau ini.
                    Namun nama pulau ini menjadi semakin populer sebagai objek wisata setelah digunakan untuk shooting serial drama “Winter Sonata” yang dibintangi Bae Yong-jun dan Choi Ji-woo.
                    Sejak drama yang diproduksi pada tahun 2002 ini meledak, begitupun pengunjung yang datang ke Nami Island.</p>
                <p>Pulau Nami semakin menunjukkan keindahan dan pesonanya. Pembangunan dan perbaikan disana sini dengan tidak melupakan unsur alami semakin membuat orang penasaran dan ingin berkunjung ke pulau ini.
                    Nami Island bahkan memiliki taman yang dinobatkan sebagai taman ramah anak diantara 14 taman anak lainnya di seluruh dunia.</p>
            </div>
        </div>
    </div>
