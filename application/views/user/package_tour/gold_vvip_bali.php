    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 mx-auto justify-content-center text-justify">
                ...
                <p class="text-center text-white mb-1" style="font-size:24px; font-weight:800;">VIP 6 DAY 5 NIGHT TOUR BALI + NYEPI</p>
                <table border="1" cellpadding="4" class="tb-tour font-italic mx-auto w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th rowspan="8" class="text-center">DAY 2</th>
                        ...
                        <tr>
                            <th rowspan="6" class="text-center">DAY 4 KUTA TOUR</th>
                            <td class="text-center">12.00</td>
                            <td>RESTAURANT</td>
                            <td>LUNCH</td>
                        </tr>
                        ...
                        <tr>
                            <th rowspan="6" class="text-center">DAY 5</th>
                            <td class="text-center">08.00</td>
                            <td>BALI NATIONAL GOLF</td>
                            <td>GOLF TOUR</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th rowspan="10" class="text-center">DAY 6</th>
                        ...
                        <tr>
                            <td rowspan="3" class="text-center">14.00</td>
                            <td>UBUD PALACE</td>
