...
<div class="container-fluid">
    ...
    <div class="bg-custom mt-5">
        <div class="row">
            <div class="col-md-12 p-5 mx-auto justify-content-center text-justify">
                ...
                <p class="text-center text-white mb-1" style="font-size:24px; font-weight:800;">VIP 4 DAY 3 NIGHT TOUR KOREA</p>
                <table border="1" cellpadding="4" class="tb-tour font-italic mx-auto w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>TOUR & CHECK UP / MEDICAL / PLASTIC SURGERY</td>
                        </tr>
                        <tr>
                            <td class="text-center">18.00</td>
    ...
    <div class="my-4 mx-auto w-50">
        <a href="<?= base_url() . 'user/tour/1' ?>" class="btn btn-bonus btn-block font-italic">Buy</a>
    </div>
