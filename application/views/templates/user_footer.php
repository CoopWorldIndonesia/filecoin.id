 ...
 <script>
     ...
     function changeMTM() {
         ...
         if (balance_mtm < price) {
             document.getElementById("lowBalance").innerHTML = "<small class='text-danger pt-1'>Your balance is low. Please deposit first</small>";
 ...
 <script>
     const card = document.querySelector(".card-priview");
