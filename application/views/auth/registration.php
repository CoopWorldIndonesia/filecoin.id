                ...
                <div class="col-md-6 m-auto">
                    ...
                    <div class="p-5">
                        ...
                        <form class="registration" method="post" action="<?= base_url('auth/registration') ?>">
                            ...
                            <?php if ($check == $count) : ?>
                            <?php elseif ($check != 0) : ?>
                                <small class="text-danger pl-3">ID already used</small>
                            <?php elseif ($check == 0) : ?>
                                <small class="text-success pl-3">ID can be used</small>
                            <?php endif ?>
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" id="firstname" name="firstname" value="<?= set_value('firstname'); ?>" placeholder="NAME">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <select class="form-control" id="country" name="country">
                                    <option class="text-black text-center" selected disabled>- SELECT COUNTRY CODE -</option>
                                    <option class="text-black text-center" value="62">INDONESIA (+62)</option>
                                    <option class="text-black text-center" value="82">KOREA (+82)</option>
                                    <option class="text-black text-center" value="1">UNITED STATE (+1)</option>
                                    <option class="text-black text-center" value="44">UNITED KINGDOM (+44)</option>
                                    <option class="text-black text-center" value="66">CHINA (+66)</option>
                                    <option class="text-black text-center" value="84">VIETNAM (+84)</option>
                                    <option class="text-black text-center" value="86">THAILAND (+86)</option>
                                </select>
                            ...
                            <div class="form-group">
                                <!-- <div class="col-8"> -->
                                <input type="text" class="form-control" id="phone" name="phone" value="<?= set_value('phone'); ?>" placeholder="PHONE" maxlength="15">
                                <?= form_error('phone', '<small class="text-danger pl-3">', '</small>'); ?>
                                <!-- </div> -->
                            </div>
                            <div class="form-group">
                                <select class="form-control" id="basecamp" name="basecamp">
                                    <option class="text-black text-center" selected disabled>- SELECT BASECAMP -</option>
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="p-5">
                                    <a class="btn btn-cancel btn-block wd-px" href="<?= base_url(); ?>auth">CANCEL</a>
                                </div>
                            </div>
                        </form>
