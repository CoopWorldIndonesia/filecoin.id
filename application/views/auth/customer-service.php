                                    ...
                                    <?php else : ?>
                                        ...
                                        <?php if ($message_robot == NULL) : ?>
                                            <div class="direct-chat-robot mt-3 mb-1" id="msg">
                                                Mohon tunggu sebentar, Admin akan segera membalas . . .
                                            </div>
                                        <?php endif ?>
                                    <?php endif ?>
                                <?php endforeach ?>
                            ...
                            <form method="post" action="<?php base_url('user/customer_service') ?>" enctype="multipart/form-data">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-append">
                                        <label for="image" class="btn btn-info custom-file" style="cursor:pointer;">Browse Image</label>
                                        <input type="file" hidden="" name="image" id="image" onchange="previewImg()"></input>
                                        <button type="submit" name="submit" id="btnSend" class="btn btn-info btn-flat">Send</button>
                                    </span>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="card" style="border-radius: 5px !important;">
                        ...
                        <form method="post" action="<?= base_url('auth/customer_service'); ?>">
                            ...
                            <div class="card-footer bg-white">
                                <button class="btn btn-info float-right mb-3" name="send">Start Chat</button>
                            </div>
                        </form>
                    </div>
                <?php endif ?>
