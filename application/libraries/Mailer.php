...
{
    protected $_ci;
    protected $sender_email = 'asia.ipfs@gmail.com'; // Isikan dengan email pengirim
    protected $sender_name = 'asia.ipfs'; // Isikan dengan nama pengirim
    protected $password = 'vssumbdrjgaxdvhd'; // Isikan dengan password email pengirim
    ...
    public function send($data)
    {
        ...
        $mail->Username = $this->sender_email; // Email Pengirim
